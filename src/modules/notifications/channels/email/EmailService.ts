...
import { buildSubmittedInquiryEmailToSalesTeamMessage } from './builders/submitted-inquiry-email-to-sales-team.builder';
import { OtpEmailPayload, InquiryEmailPayload } from '../../types/notification.types';
...
export class EmailService {
  ...
  async sendSubmittedInquiryEmailToSalesTeam(
    ...
    const message = buildSubmittedInquiryEmailToSalesTeamMessage(payload);
    //console.log(
    //  '################ EmailService.sendSubmittedInquiryEmailToSalesTeam: Built email message:',
    //  message
    //);
    return this.send(message);
  }
