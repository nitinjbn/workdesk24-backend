...
router.post('/users/addDesignation', userController.addDesignation.bind(userController));
router.post('/users/updateDesignation', userController.updateDesignation.bind(userController));
...
router.post(
  '/users/createUser',
  upload.single('media'),
  userController.createAppUser.bind(userController)
);
router.post(
  '/users/updateUser',
  upload.single('media'),
  userController.updateAppUser.bind(userController)
);
