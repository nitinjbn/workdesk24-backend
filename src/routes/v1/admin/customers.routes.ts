...
router.post(
  '/customers/addCustomerType',
  customerController.addCustomerType.bind(customerController)
);
router.post(
  '/customers/updateCustomerType',
  customerController.updateCustomerType.bind(customerController)
);
router.post(
  '/customers/getCustomerTypes',
  customerController.getCustomerTypes.bind(customerController)
);
...
router.post(
  '/customers/uploadMedia',
  upload.single('media'),
  customerController.uploadMedia.bind(customerController)
);
